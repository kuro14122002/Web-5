                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    <motion.button
                      ...
                      whileTap={{ scale: 0.95 }}
                      className="bg-gradient-to-r from-violet-600 to-indigo-600 text-white px-8 py-3 rounded-full font-medium text-lg"
                    >
                      {slide.cta}
                    </motion.button>
                    <motion.button
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      className="bg-transparent border-2 border-white text-white px-8 py-3 rounded-full font-medium text-lg"
                    >
                      {t('watchTrailer')}
                    </motion.button>
                  </div>
      ...
      <div className="absolute bottom-10 right-10 z-30">
        ...
        >
          ...
          <div className="flex gap-3">
            <span className="text-white bg-white/10 p-2 rounded hover:bg-white/20 cursor-pointer transition-colors">
